...
import particle22 from 'assets/particle22.png';
import particle222 from 'assets/particle222.png';
import perlin from 'assets/perlin-512.png';
...
THREE.GPUParticleSystem = function(options) {
	...
	var GPUParticleShader = {
		...
		fragmentShader: [
			...
			'gl_FragColor = vec4(vColor.rgb * tex.a, alpha);',
	...
	self.particleNoiseTex = self.PARTICLE_NOISE_TEXTURE || textureLoader.load(perlin);
	self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	// sprite texture rendered for each particle
  self.particleSpriteTex = self.PARTICLE_SPRITE_TEXTURE || textureLoader.load(particle2);
